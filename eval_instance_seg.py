...
def get_args():
    ...
    parser.add_argument('-gt', '--gt-seg', type=str, default='demo_data/lucchi_gt_test.h5',
                        help='path to ground truth segmentation result')

    parser.add_argument('-p', '--predict-seg', type=str, default='demo_data/lucchi_pred_UNet_label_test.h5',
    ...
    parser.add_argument('-ph', '--predict-heatmap', type=str, default='demo_data/lucchi_pred_UNet_heatmap_test.h5',
